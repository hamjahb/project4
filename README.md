...
1.  Rename the directory from project-4 -> your-app-name.
1.  Empty [`README.md`](README.md) and fill with your own content.
1.  Move into the new project and `git init`.
1.  Replace all instances of `'project-4'` with your app name.
1.  Install dependencies with `npm install`. 
    - if this doesn't work then run `npm install --save bcryptjs && npm uninstall --save bcrypt` first then run `npm install` again. (make sure you replace every instance of `require('bcryptjs')` in your app into `require('bcryptjs')`
